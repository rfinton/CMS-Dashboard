...
<head>
	...
	<title>CMS | Service Distribution</title>
...
<body>
	...
	<div class="container" id="filter">
		<h1>Service Distribution</h1>
		<p>Analysis of clinics offering services within a specified category</p>
	...
	<div id="results-view">
		<div id="clinics"></div>
		<div class="charts" style="display: initial;"> </div>
		<div id="stats"></div>
	</div>
	...
	<script>
		const endpoint = '/cms/api/servdist/servdist.php';
		...
		document.forms[0].addEventListener('submit', function(ev) {
			...
			let category = encodeURIComponent(selected[3].value);
